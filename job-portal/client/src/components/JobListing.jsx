            ...
            <section className='w-full lg:w-3/4 text-gray-600 max-lg:px-4'>
                ...
                {filteredJobs.length > 0 && (
                    <div className='flex items-center justify-center space-x-2 mt-10'>
                        <a href="#job-list" onClick={(e) => { e.preventDefault(); setCurrentPage(Math.max(currentPage - 1, 1)); }}>
                            <img src={assets.left_arrow_icon} alt="Previous Page" />
                        </a>
                        {Array.from({ length: Math.ceil(filteredJobs.length / 6) }).map((_, index) => (
                            <a href="#job-list" key={index} onClick={(e) => { e.preventDefault(); setCurrentPage(index + 1); }}>
                        ...
                        <a href="#job-list" onClick={(e) => { e.preventDefault(); setCurrentPage(Math.min(currentPage + 1, Math.ceil(filteredJobs.length / 6))); }}>
